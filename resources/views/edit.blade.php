...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('編集ページ') }}</div>
                ...
                <div class="card-body">
                    <form action="/edit_post" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea cols="50" rows="10" placeholder="50文字以内でお願いします。" type="text" class="form-control @error('content') is-invalid @enderror" name="content" required autocomplete="taxt" autofocus>{{ $article -> content }}</textarea>
                                @error('content')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
